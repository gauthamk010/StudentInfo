...
export const StudentScholarshipTable = () => {
  ...
  return(
    <Layout>
            ...
            <h2 className="text-lg text-center text-stone-800 font-bolder m-2 underline pt-3 mb-3">Scholarship Details</h2>
            ...
            <div className={`${styles.tableContainer}`}>
              <table className="w-full max-w-full border border-2 border-lime-600 table-auto">
                ...
                <tr className='bg-zinc-300'>
                    <th className="border px-4 py-2">Scholarship Received? :</th>
                    <th className="border px-4 py-2">Name of Scholarship</th>
                </tr>
                </thead>

                <tbody>
                    <tr className="hover:bg-gray-100">
                        <td className="border px-4 py-2">{studentData.scholarship?.received === "no-scholarship-received" ? "No" : "Yes"}</td>
                        <td className="border px-4 py-2">{studentData.scholarship?.scholarship_name}</td>
                    </tr>
                </tbody>
