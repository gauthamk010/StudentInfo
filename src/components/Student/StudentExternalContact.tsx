...
export const StudentExternalContactDetails = () => {
  ...
  return(
      <Layout>
              ...
              <h2 className="text-lg text-center text-stone-800 font-bolder m-2 underline pt-3 mb-3">External Contact Details</h2>
              ...
              <div className={`${styles.tableContainer}`}>
                ...
                <tr className='bg-zinc-300'>
                    <th className="border px-1 py-1">Guardian Name</th>
                    <th className="border px-1 py-1">Guardian Phone Number</th>
                    <th className="border px-1 py-1">Emergency Contact Name</th>
                    <th className="border px-1 py-1">Emergency Contact Phone Number</th>
                </tr>
                </thead>

                <tbody>
                  <tr className="hover:bg-gray-100">
                      <td className="border px-1 py-1">{studentData.guardian_name}</td>
                      <td className="border px-1 py-1">{studentData.guardian_contact}</td>
                      <td className="border px-1 py-1">{studentData.emergency_contact_name}</td>
                      <td className="border px-1 py-1">{studentData.emergency_contact_number}</td>
                  </tr>
                </tbody>
