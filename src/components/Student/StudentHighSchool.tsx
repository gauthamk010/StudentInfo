...
export const StudentHighSchoolTable = () => {
  ...
  return(
    <Layout>
            ...
            <h2 className="text-lg text-center text-stone-800 font-bolder m-2 underline pt-3 mb-3">High School Details</h2>
            ...
            <div className={`${styles.tableContainer}`}>
              <table className="w-full max-w-full border border-2 border-lime-600 table-auto">
                ...
                <tbody>
                    ...
                    <td className="border px-4 py-2">{studentData.highschool?.college_name}</td>
                    <td className="border px-4 py-2">{studentData.highschool?.board_name?.toUpperCase()}</td>
                    <td className="border px-4 py-2">{studentData.highschool?.pass_year}</td>
                    <td className="border px-4 py-2">{studentData.highschool?.total}/600</td>
                    <td className="border px-4 py-2">{studentData.highschool?.percentage}%</td>
                    </tr>
                </tbody>
