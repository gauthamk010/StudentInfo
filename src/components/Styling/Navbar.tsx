...
export const Navbar = () => {
    ...
    return (
        <div className="flex items-center justify-between w-full bg-gray-700 p-3 border-b-2 border-inset border-white">
            <nav className="primary-navbar flex items-center w-full h-12 justify-between">
                ...
                />
                <h1 className="text-4xl sm:text-3xl font-extrabold italic text-white tracking-wide">
                    LearnUp
                </h1>
                </div>
                ...
                <div className="flex items-center justify-between mr-2">
                    ...
                    <button className="text-white border-2 border-white border-inset shadow-md rounded-lg hover:shadow-gray-400 hover:shadow-lg m-2 p-2 cursor-pointer"
                        onClick = {toggleNotificationDropdown}
                    >
                        <svg data-slot="icon" aria-hidden="true" fill="none"
                            strokeWidth="1.25" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-8"> 
                    ...
                    {isNotifOpen && 
                    (
                            <div ref={dropdownRef} className="absolute top-[50px] right-[80px] w-80 h-72 bg-white border border-gray-300 shadow-lg rounded-md z-50 overflow-y-scroll"
                            >
                                <ul className="py-1">
                    ...
                    {/* Profile Pic Button */}
                    <span 
                        className="text-white border-2 border-white border-inset shadow-md rounded-lg hover:shadow-gray-400 hover:shadow-lg m-2 p-2 cursor-pointer" 
                        onClick={togglePicDropdown}
                    >
                        <svg data-slot="icon" aria-hidden="true" fill="none" strokeWidth="1.25" stroke="currentColor"
                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-8">
